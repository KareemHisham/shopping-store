        ...
        <section className="h-[100vh] flex items-center flex-1">
            ...
            <div className="w-full px-3">
                ...
                <div className="mb-5">
                    ...
                    <p className="mt-2 text-base font-semibold text-grey">Welcome to Furniro</p>
                </div>
                ...
                <form action="" method="POST">
                    ...
                    <div className="form-group">
                        ...
                        <input type="text" name="phone" id="phone" placeholder="Enter your phone number" className="form-control" />
                    </div>
