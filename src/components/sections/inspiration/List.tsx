...
const InspirationList = () => {
  ...
  return (
    <div className="flex-1 w-full md:w-7/12 flex gap-2">
      {/** active */}
      <div className="w-[40vw] md:w-[25vw] bg-indigo-300 h-5/6 flex-shrink-0"></div>
      {/** remaining */}
      <div className="flex-col overflow-hidden h-5/6 relative">
        {/** icon */}
        <span className="absolute left-[40vw] md:left-[25vw] top-1/2 w-4 h-4 bg-primary"></span>
        {/** img list */}
        <div className="flex gap-2 h-5/6">
          <div className="w-[40vw] md:w-[25vw] h-full bg-indigo-100 flex-shrink-0"></div>
          <div className="w-[40vw] md:w-[25vw] h-full bg-indigo-100 flex-shrink-0"></div>
        </div>
        {/** status */}
